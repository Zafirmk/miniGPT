...
def get_or_build_tokenizer(dpath, tokenizer_batch_size, lang):
    ...
    if not tokenizer_path.exists():
        ...
        tokenizer.train_from_iterator(get_all_sentences(dpath, tokenizer_batch_size, lang), trainer=trainer)
